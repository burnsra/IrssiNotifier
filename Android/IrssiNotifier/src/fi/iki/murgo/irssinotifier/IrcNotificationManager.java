            ...
            case Single:
                ...
                if (msg.isPrivate()) {
                    if (unreadCount <= 1) {
                        title = String.format(
                                context.getResources().getString(
                                        R.string.notification_msg_title_private), msg.getNick());
                        text = msg.getMessage();
                    } else {
                        title = String.format(
                                context.getResources().getString(
                                        R.string.notification_msg_title_multiple), unreadCount);
                    ...
                    if (unreadCount <= 1) {
                        title = String.format(
                                context.getResources().getString(
                                        R.string.notification_msg_title_general), msg.getChannel());
                        text = String.format(
                                context.getResources().getString(
                                        R.string.notification_msg_text_general), msg.getNick(),
                                msg.getMessage());
                    } else {
                        title = String.format(
                                context.getResources().getString(
                ...
                if (msg.isPrivate()) {
                    ...
                    text = String.format(
                            context.getResources()
                                    .getString(R.string.notification_msg_text_general), msg
                                    .getNick(), msg.getMessage());
                }
                break;
